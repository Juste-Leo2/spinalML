...
import spinalML.poolings.{MaxPool2DTestComp}

/**
 * Flow-control formal spec of MaxPool2DOp (4x4, K=2, stride=2, C=1).
 ...
 * co-simulation (tests/python/test_maxpool2d.py, bit-exact golden models).
 ...
 */
class MaxPool2DFormal_I8 extends Component {
  val dut = FormalDut(MaxPool2DTestComp(SInt(8 bits)))
...
class MaxPool2DFormal_FP4 extends Component {
  val dut = FormalDut(MaxPool2DTestComp(FP4_E2M1()))
...
object MaxPool2DFormal {
  def main(args: Array[String]): Unit = {
    FormalConfig
      ...
      .doVerify(new MaxPool2DFormal_I8, "maxpool2d_i8")
    ...
    FormalConfig
      ...
      .withEngies(List(SmtBmc(solver = SmtBmcSolver.cvc4)))
      .workspacePath("formal")
      .doVerify(new MaxPool2DFormal_FP4, "maxpool2d_fp4")
  }
}
