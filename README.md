...
*   [UART Bridge & Hardware Deployment](docs/uart_bridge.md): Specifications and protocol documentation for the physical UART communication chain, CSR bridge, and host Python driver.
