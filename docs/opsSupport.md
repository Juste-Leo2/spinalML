...
| `Multi-Head Attention` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Same wiring as Classical Attention (shared `ClassicalAttentionHW`, scales shared across Q/K/V/O). Validated on all six wXaY schemes at seqLen=4/heads=2. |
