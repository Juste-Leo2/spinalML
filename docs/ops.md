...
## Basic Arithmetic
| Operation | I4 / I8 | FP4 / FP8 | BF16 / I32 | Notes |
| :--- | :---: | :---: | :---: | :--- |
...
| `Exp` | ✅ (LUT) | ✅ (LUT) | ❌ | Element-wise exponential. Uses BRAM LUT for small types. |
| `Log` | ❌ | ❌ | ❌ | Element-wise natural logarithm. |
| `Abs` | ✅ | ✅ | ✅ | Element-wise absolute value. |
| `sqrt`| ❌ | ❌ | ❌ | Square Root. |
| `rsqrt` | ✅ (LUT) | ✅ (LUT) | ❌ | Inverse Square Root (1/sqrt(x)). Uses BRAM LUT. |
