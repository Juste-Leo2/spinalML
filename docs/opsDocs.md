...
| **Div** | `div(a, b)` | Element-wise division | FloatML: Mul + Reciprocal (LUT/PWL). Integers ≤32 bits: exact ONNX `Div` (trunc toward zero, saturating; ≤8 bits combinational, I16/I32 serial FSM `width + 2` cycles; Wave 5 steps 5A/5B) |
